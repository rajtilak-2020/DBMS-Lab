-- ============================================================================
-- DBMS LAB ASSIGNMENT: IMPLEMENTATION OF KEYS IN RELATIONAL DATABASES
-- System: University Management Database
...
-- ----------------------------------------------------------------------------
-- STEP 1: DROP TABLES (TO ENSURE CLEAN RE-RUNNABILITY)
-- ----------------------------------------------------------------------------
...
--   - Unique Key: Department_Name (No two departments can have the same name)
...
-- Table 4: Enrollment (TASK 7: Composite Primary Key)
...
-- ----------------------------------------------------------------------------
SELECT '=== DEPARTMENT TABLE RECORDS ===' AS Header;
SELECT * FROM Department;

SELECT '=== COURSE TABLE RECORDS ===' AS Header;
SELECT * FROM Course;

SELECT '=== STUDENT TABLE RECORDS ===' AS Header;
SELECT * FROM Student;

SELECT '=== ENROLLMENT TABLE RECORDS ===' AS Header;
...
SELECT '=== TASK 9 VERIFICATION: Student 1 enrolled in new Course 505 ===' AS Header;
...
SELECT '=== TASK 10: Student Details with Department Name (INNER JOIN) ===' AS Header;
SELECT 
    s.Student_ID,
    s.Roll_Number,
    s.Student_Name,
...
SELECT '=== TASK 11: Courses Registered by Student 1 (Aarav Sharma) ===' AS Header;
SELECT 
    s.Student_ID,
    s.Student_Name,
    s.Roll_Number,
...
SELECT '=== TASK 12: Comprehensive Student Enrollment Details (3-Table JOIN) ===' AS Header;
SELECT 
    s.Roll_Number,
    s.Student_Name,
    d.Department_Name,
